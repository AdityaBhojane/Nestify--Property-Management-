        ...
        <>
            <div className="w-full flex items-center gap-5 p-4">
                <div className="min-w-[250px] max-w-[250px] rounded-xl">
                    <img src={image} alt="property image" className='rounded-xl  cursor-pointer'/>
                </div>
                <div className="flex flex-col gap-2">
                    <span className="bg-[#DADEFA] px-6 py-2 rounded-lg text-[#457BE8] font-semibold w-[100px]">{price}</span>
